/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: cff0bf5338b07c4051b6e94c985e4785)
// Runtime types generated with workerd@1.20260801.1 2026-07-24 nodejs_compat
interface __BaseEnv_Env {
  ...
  SESSION_AFFINITY: DurableObjectNamespace<
    import("./src/worker").SessionAffinity
  >;
  SESSION_AFFINITY_INDEX: DurableObjectNamespace<
    import("./src/worker").SessionAffinityIndex
  >;
  RESPONSES_WEBSOCKET: DurableObjectNamespace<
    import("./src/worker").ResponsesWebSocketProxy
  >;
}
